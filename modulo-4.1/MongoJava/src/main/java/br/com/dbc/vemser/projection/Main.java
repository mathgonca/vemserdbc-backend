package br.com.dbc.vemser.projection;
...
public class Main {
    public static void main(String[] args) {
        ...
        alunos.find()
                .projection(fields(include("nome", "data_nascimento"), excludeId()))
                .forEach(document -> System.out.println(document.toJson()));

        Document aluno = alunos.find(new Document("nome", "Gabriel"))
                .projection(fields(include("idade", "curso.nome", "status")))
                .first();
        System.out.println("-".repeat(75));
        ...
        alunos.find(Filters.lte("idade", 25))
                .projection(fields(include("idade", "habilidades", "notas"), excludeId()))
                .forEach(document -> System.out.println(document.toJson()));
