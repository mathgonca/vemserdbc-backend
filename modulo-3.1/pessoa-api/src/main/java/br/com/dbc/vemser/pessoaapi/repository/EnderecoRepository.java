...
public class EnderecoRepository {
    ...
    public EnderecoRepository() {
        listaEnderecos.add(new Endereco(COUNTER.incrementAndGet(), 1, TipoEndereco.COMERCIAL,
                ...
                "Brasil"));
        listaEnderecos.add(new Endereco(COUNTER.incrementAndGet(), 2, TipoEndereco.COMERCIAL,
                "Quadra J Dois", 123, null, "92440166", "Canoas", "RS",
                "Brasil"));
        listaEnderecos.add(new Endereco(COUNTER.incrementAndGet(), 3, TipoEndereco.RESIDENCIAL, "Rua G",
                123, null, "92412085", "Canoas", "RS", "Brasil"));
    }
